...
BEGIN
	INSERT INTO CONGNHAN VALUES(MACN, HOTEN, CONCAT(NAM_SINH, '-', THANG_SINH,'-', NGAY_SINH), MATINH, GIOITINH, GHICHU);
END $$
...
BEGIN
	INSERT INTO NHANVIENDACTHU VALUES(MANV, HOTEN, CONCAT(NAM_SINH, '-', THANG_SINH,'-', NGAY_SINH), CONGVIEC, MATINH, GIOITINH, LUONG);
END $$
...
CREATE VIEW LUONG_TONG_QUAN AS
SELECT TRUNCATE((THANG_1)*V.LUONG/28, -4) AS LUONG_THANG_1,
	   TRUNCATE((THANG_2)*V.LUONG/28, -4) AS LUONG_THANG_2,
       TRUNCATE((THANG_3)*V.LUONG/28, -4) AS LUONG_THANG_3,
       TRUNCATE((THANG_4)*V.LUONG/28, -4) AS LUONG_THANG_4,
       TRUNCATE((THANG_5)*V.LUONG/28, -4) AS LUONG_THANG_5,
       TRUNCATE((THANG_6)*V.LUONG/28, -4) AS LUONG_THANG_6,
       TRUNCATE((THANG_7)*V.LUONG/28, -4) AS LUONG_THANG_7,
       TRUNCATE((THANG_8)*V.LUONG/28, -4) AS LUONG_THANG_8,
       TRUNCATE((THANG_9)*V.LUONG/28, -4) AS LUONG_THANG_9,
       TRUNCATE((THANG_10)*V.LUONG/28, -4) AS LUONG_THANG_10,
       TRUNCATE((THANG_11)*V.LUONG/28, -4) AS LUONG_THANG_11,
       TRUNCATE((THANG_12)*V.LUONG/28, -4) AS LUONG_THANG_12
FROM CONGVIEC AS V 
INNER JOIN PHANCONG AS P ON P.MACV=V.MACV AND MID(MACN, 4,3)=V.LOAISP
	INNER JOIN CHAMCONG AS C ON C.MACN=P.MACN;
